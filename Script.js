...
function getStateNickname(State){
    for (var i = 0; i < stateNicknames.length;i++){
        if (stateNames[i]== State){ //check if the current state matches the inputed state
...
for (var i = 0; i < stateNames.length; i++){
        if (stateNames[i] == State){ //Checks for match
        return population[i] //returns if matched state is found
        }
    }
...
for (var i = 0; i < stateNames.length; i++){
        if (stateNames[i] == State){//Finds matches in the list
...
function getStateMedianIncome(State) {
  for (var i = 0; i < stateNames.length; i++) {
    if (stateNames[i] == State) { //Check the state
      return medianIncome[i];// return the income
    }
  }
...
function getStatePovertyPercent(State) {
  for (var i = 0; i < stateNames.length; i++) {
    if (stateNames[i] == State) { //Check state
